...
{
    public partial class BCalendarWithEventsSlotChildren<TCalendarWithEvents> where TCalendarWithEvents : ICalendarWithEvents
    {
        [Parameter]
        ...
        [Parameter]
        public Func<CalendarEventVisual, CalendarDaySlotScope, RenderFragment> Mapper { get; set; }
