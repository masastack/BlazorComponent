...
{
    public class StringNumberDate : OneOfBase<string, int, DateTime>
    {
        StringNumberDate(OneOf<string, int, DateTime> _) : base(_) { }

        public static implicit operator StringNumberDate(string _) => new(_);
        public static implicit operator StringNumberDate(int _) => new(_);
        public static implicit operator StringNumberDate(DateTime _) => new(_);
