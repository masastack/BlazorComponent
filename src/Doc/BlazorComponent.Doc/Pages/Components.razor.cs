...
using BlazorComponent.Doc.Shared;
using Microsoft.AspNetCore.Components;
using Microsoft.AspNetCore.Components.Routing;

namespace BlazorComponent.Doc.Pages
{
    public partial class Components : ComponentBase, IDisposable
    {
        ...
        private async Task HandleNavigate()
        {
            ...
            else
            {
                ...
                _filePath = $"site/BlazorComponent.Doc/Demos/Components/{_demoComponent?.Title}/doc/index.{CurrentLanguage}.md";
